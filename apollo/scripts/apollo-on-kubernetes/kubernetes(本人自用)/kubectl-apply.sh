...
#kubectl apply -f apollo-env-fat-alpha/service-mysql-for-apollo-test-alpha-env.yaml --record && 
kubectl apply -f apollo-env-fat-alpha/service-apollo-config-server-test-alpha.yaml --record && \
kubectl apply -f apollo-env-fat-alpha/service-apollo-admin-server-test-alpha.yaml --record

# uat-env(test-beta-env)
# kubectl apply -f apollo-env-uat-beta/service-mysql-for-apollo-test-beta-env.yaml --record && 
kubectl apply -f apollo-env-uat-beta/service-apollo-config-server-test-beta.yaml --record && \
kubectl apply -f apollo-env-uat-beta/service-apollo-admin-server-test-beta.yaml --record
